...
//	}
	...
	//Linkedhashset maintain the insertion  order we can use use hashSet to find duplicate 
	public static void main(String[] agrs) {
		String s = "Appleepplee";
		LinkedHashSet<Character> see = new LinkedHashSet<Character>();
